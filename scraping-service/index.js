...
const { validateEnvironmentVariables, validateAllowedOrigins } = require("./utils/env-validator");
...
const PROTECTED_ENDPOINTS = new Set(["/scrape", "/scrape-keyence", "/scrape-habasit"]);
...
app.use((req, res, next) => {
	if (getShutdownState() && PROTECTED_ENDPOINTS.has(req.path)) {
