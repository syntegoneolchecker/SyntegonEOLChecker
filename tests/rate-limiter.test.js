...
describe("Rate Limiter", () => {
	...
	describe("checkRateLimit", () => {
		it("should throw for unknown endpoint", async () => {
			await expect(checkRateLimit("unknown-endpoint", "1.2.3.4")).rejects.toThrow(
				"Unknown rate limit endpoint"
			);
		});
	...
	describe("recordAttempt", () => {
		it("should throw for unknown endpoint", async () => {
			await expect(recordAttempt("unknown-endpoint", "1.2.3.4")).rejects.toThrow(
				"Unknown rate limit endpoint"
			);
		});
