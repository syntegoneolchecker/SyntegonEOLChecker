...
const { validateInitializeJob, validateCsvData, sanitizeString } = require('../netlify/functions/lib/validators');
...
describe('Validators - Extended Tests', () => {
    ...
    describe('validateCsvData', () => {
        ...
        test('should accept data with empty strings in cells', () => {
            const result = validateCsvData([['', ''], ['x', '']]);
            expect(result.valid).toBe(true);
            expect(result.error).toBeNull();
        });
    });
