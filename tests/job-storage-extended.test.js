...
describe("Job Storage - Extended", () => {
	...
	describe("saveJobUrls", () => {
		...
		test("should throw when job not found", async () => {
			...
			await expect(jobStorage.saveJobUrls("job-missing", [])).rejects.toThrow(
	...
	describe("updateJobStatus", () => {
		...
		test("should throw when job not found", async () => {
			...
			await expect(jobStorage.updateJobStatus("job-missing", "complete")).rejects.toThrow(
				"Job job-missing not found"
			);
		});
	});
	...
	describe("markUrlFetching", () => {
		...
		test("should throw when job not found", async () => {
			...
			await expect(jobStorage.markUrlFetching("job-missing", 0)).rejects.toThrow(
				"Job job-missing not found"
			);
		});
	...
	describe("saveUrlResult", () => {
		...
		test("should throw when job not found", async () => {
			...
			await expect(jobStorage.saveUrlResult("job-missing", 0, {})).rejects.toThrow(
				"Job job-missing not found"
			);
		});
	});
	...
	describe("saveFinalResult", () => {
		...
		test("should throw when job not found", async () => {
			...
			await expect(jobStorage.saveFinalResult("job-missing", {})).rejects.toThrow(
				"Job job-missing not found"
			);
		});
	});
	...
	describe("replaceJobUrls", () => {
		test("should replace all URLs in job", async () => {
			...
			expect(savedJob.urls[1]).toEqual(
				expect.objectContaining({
					url: "https://new2.com",
					index: 1,
					status: "pending"
		...
		test("should preserve pre-set status on URLs", async () => {
			...
			const newUrls = [{ url: "https://a.com", status: "complete" }];
		...
		test("should throw when job not found", async () => {
			...
			await expect(jobStorage.replaceJobUrls("job-missing", [])).rejects.toThrow(
				"Job job-missing not found"
			);
		});
	});
	...
	describe("addUrlToJob", () => {
		test("should add URL with next index", async () => {
			...
			expect(savedJob.urls[2]).toEqual(
				expect.objectContaining({
					url: "https://c.com",
					index: 2,
					status: "pending"
		...
		test("should throw when job not found", async () => {
			...
			await expect(
				jobStorage.addUrlToJob("job-missing", { url: "https://a.com" })
