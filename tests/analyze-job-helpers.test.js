...
describe('Analyze Job - Helper Functions', () => {
    ...
    describe('buildResultSection', () => {
        it('should build a formatted result section', () => {
            const urlInfo = { title: 'Product Page', url: 'https://example.com', snippet: 'A product snippet' };
    ...
    describe('GroqAnalyzer', () => {
        ...
        describe('parseResponseText', () => {
            it('should parse valid JSON', () => {
                const json = '{"status": "ACTIVE", "explanation": "test", "successor": {"status": "UNKNOWN", "model": null, "explanation": "active"}}';
            ...
            it('should throw on oversized response', () => {
                ...
                expect(() => analyzer.parseResponseText(oversized))
                    .toThrow('exceeds maximum expected size');
            });
        });
        ...
        describe('validateResult', () => {
            ...
            it('should reject missing status', () => {
                expect(() => analyzer.validateResult({
                    explanation: 'test',
                    successor: {}
        ...
        describe('extractGeneratedText', () => {
            ...
            it('should throw on unexpected format', () => {
                expect(() => analyzer.extractGeneratedText({}))
                    .toThrow('Unexpected response format');
                expect(() => analyzer.extractGeneratedText({ choices: [] }))
                    .toThrow('Unexpected response format');
            });
        });
    });
